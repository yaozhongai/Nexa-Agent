...
from app.trace.schema import TraceVisibility
from app.trace.service import get_trace_events, build_timeline_items
from app.trace.sse import subscribe_trace_events
...
async def list_events(
    trace_id: str,
    after_seq: int | None = Query(None, description="断线重连起始 seq"),
